...
\newcommand\hmmax{0}
\newcommand\bmmax{0}
%\input{preamble-fancy-very-minimal-newpxtext2}
\input{preamble-fancy-very-minimal-opentype-libertinus}
%\input{preamble}
\usepackage[textwidth=15.5cm,top=2.5cm,bottom=2.5cm]{geometry}
\usepackage{comment}

\title{Lecture Notes}
\author{on Assorted Topics in Category Theory}
...
\newcommand{\udgMod}{\underline{\dgMod}}
\newcommand{\dbgMod}{\cat{dbgMod}}
...
\includeonly{lectures/graded-algebras,lectures/dg-algebras}
...
\include{lectures/lifting-properties}

\include{lectures/model-categories}

\include{lectures/model-categories-and-homotopy-(co)limits}

\include{lectures/grothendieck-categories-freyd-mitchell}

\include{lectures/graded-algebras}

\include{lectures/dg-algebras}
